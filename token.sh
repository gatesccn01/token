...
echo -e "$bar1"
    echo -e "${rojo}########################################################${cierre}"
    echo -e "${rojo}#    ${verde}Bienvenido${blanco}, Gracias por utilizar TOKEN ADM BY LATAMSRC ${guinda}https://t.me/Smandchat    ${rojo}# ${cierre}"
    echo -e "${rojo}#    ${blanco}Este SCRIPT autoriza su token ID para usar${cierre}        ${rojo}# ${cierre}"
    echo -e "${rojo}#    ${blanco}         Nuestras apk...                  ${cierre}        ${rojo}# ${cierre}"
    echo -e "${rojo}#   ${melon}-----------------------------------------------    ${rojo}#${cierre}"
    echo -e "${rojo}#          ${blanco}dev: ${moradoL}@GATESCCN ${blanco}- ${verdeR}EL MANDARIN SNIFF ${amarillo}LATAMSRC${cierre}           ${rojo}#${cierre}"
    echo -e "${rojo}########################################################${cierre}"
    echo -e "$bar1"
}
...
echo -e "${rojo}ESTA CONTRASEÑA NO PUEDE SER CAMBIADA UNA VEZ INGRESADA"
echo -e "$bar2"
...
crear () {
    clear
    TITLE="${blanco}LATAMSRC ${verdeR}DESENCRIPTADORESHC"
echo -e "$TITLE"
echo -e ""
...
online (){                                                               
clear
TITLE="${blanco}LATAMSRC ${verdeR}By Mandarin"
...
menu () {
  clear
echo -e "${melon}               == Token Auth == (${amarillo}LATAMSRC${cierre}${melon})
${bar1}
